  ...
  const defaultPosts = [
    {
      ...
      text: "Working on AI projects like Parkinson’s disease detection showed me how powerful tech can be in solving real-world problems. I love taking deep learning and applying it to things that actually matter.",
    },
    {
      id: 2,
      title: "My Thoughts on Design & Aesthetics",
      text: "To me, design is all about balancing how it works with how it feels. Minimalist layouts and dark themes always catch my eye and push me to make things that feel personal and modern.",
    },
    {
      id: 3,
      title: "Balancing Tech and Creativity",
      text: "I code, I dance, and I’ve realized creativity doesn’t just live in art — it lives in logic and algorithms too. Every project is like creating a rhythm for the mind.",
    },
    {
      id: 4,
      title: "The Beauty of Simple Code",
      text: "Clean code isn’t just about writing less — it’s about being clear. Elegant code feels like poetry to me; every function should have its own rhythm and purpose.",
    },
  ];
