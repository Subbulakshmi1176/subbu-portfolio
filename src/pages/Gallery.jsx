  ...
  personal: [
    {
      id: 1,
      caption:
        "Weekend getaway to clear my head ☠️ Sometimes inspiration strikes when you’re away from the screen.",
      photos: ["/gallery/subbu1.jpg", "/gallery/subbu2.jpg"],
    },
  ],
  projects: [
    {
      ...
      photos: ["/gallery/p1.png", "/gallery/p2.png"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Solved 300+ LeetCode questions 🏆!",
      photos: ["/gallery/leet.jpg"],
    },
    {
      id: 2,
      caption: "Solved 140+ GeeksforGeeks questions 🏆!",
      photos: ["/gallery/geek.png"],
    },
  ],
};
